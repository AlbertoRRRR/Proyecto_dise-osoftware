 ...
 * @author Admin
 */
public class modificarMembresiaCliente extends javax.swing.JFrame {

    /**
     * Creates new form modificarMembresiaCliente
     */
    public modificarMembresiaCliente(String codigoMembresias,String fechaMembresia) throws SQLException {
        initComponents();
        ...
        Map<String, String> clienteData = objetoMembresiaPorCliente.asignarMembresiaCliente(codigoMembresias,fechaMembresia);

        if (clienteData != null && !clienteData.isEmpty()) {
            String IDCliente = clienteData.get("FKCliente");
            String membresia = clienteData.get("FKMembresia");
            String fechaInicio = clienteData.get("membresiaFechaInicio");
            String fechaFin = clienteData.get("membresiaFechaFin");
   
            try {
            SimpleDateFormat inputDateFormat = new SimpleDateFormat("yyyy-MM-dd");
            SimpleDateFormat outputDateFormat = new SimpleDateFormat("dd/MM/yyyy");

            String strFechaConvertida = outputDateFormat.format(inputDateFormat.parse(fechaInicio));
            paramFechaInicio.setText(strFechaConvertida);
            String strFechaConvertida2 = outputDateFormat.format(inputDateFormat.parse(fechaFin));
            paramFechaFin.setText(strFechaConvertida2);
            } catch (ParseException e) {
                System.out.println("Error al convertir la fecha: " + e.getMessage());
            }
            paramDni.setText(IDCliente);
            paramDni.setEditable(false);
            paramFechaInicio.setEditable(false);
        }
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        membresiaPorCliente.ModificarMembresiaCliente(paramDni,comboMembresias, paramFechaInicio, paramFechaFin);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                manejoMembresiaPorCliente manejoMembresiaPorCliente = new manejoMembresiaPorCliente();
                String idMembresia = manejoMembresiaPorCliente.devolverCodigo();
                String fechaMembresia = manejoMembresiaPorCliente.devolverFecha();
               try {
                    new modificarMembresiaCliente(idMembresia,fechaMembresia).setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(modificarMembresiaCliente.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
