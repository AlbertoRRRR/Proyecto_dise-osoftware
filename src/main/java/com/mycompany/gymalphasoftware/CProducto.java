...
public class CProducto {
    JDialog auxiliar;
     public void mostrarProducto(JTable paramTablaProductos){
        ...
        sql="SELECT\n" +
            ...
            "proovedor.razonSocialProovedor\n" +
            "FROM elemento\n" +
            "INNER JOIN proovedor ON proovedor.RUCProovedor = elemento.FKProovedor;";
    ...
    public void InsertarProductos(String paramNombre, String paramPrecio, String paramCosto, String paramStock, String paramDescripcion, String paramCategoria, String paramProovedor, String valore7){
        ...
        String codigoProovedor = obtenerIdPorValor(paramProovedor);
        try{  
            CallableStatement cs = objetoConexion.establecerConexion().prepareCall(consulta);
            ...
            cs.setString(7, codigoProovedor);
            cs.execute();
    ...
    public void mostrarProductoSimple(JTable paramTablaProductos){
        ...
        try{
            ...
            while (rs.next()){
                ...
                modelo.addRow(new Object[]{rs.getString(1),rs.getString(2),rs.getString(3),rs.getString(4),rs.getString(5),rs.getString(6),rs.getString(7),rs.getString(8)});
            }
    ...
    public void BuscarProducto(JTextField paramBusqueda,JTable paramTablaProductos) throws SQLException{
        CConexion objetoConexion = new CConexion();
        ...
        try{
            ...
            while (rs.next()){
                ...
                modelo.addRow(new Object[]{rs.getString(1),rs.getString(2),rs.getString(3),rs.getString(4),rs.getString(5),rs.getString(6),rs.getString(7),rs.getString(8),botonDetalle, botonEliminar});
            }
