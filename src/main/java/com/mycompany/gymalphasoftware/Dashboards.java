...
public class Dashboards extends javax.swing.JFrame {
    ...
    private void btnMiembrosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMiembrosActionPerformed
        lblTitulo.setText("Miembros");
        
        ClientesPanel ClientesPanel = new ClientesPanel(this);
        ClientesPanel.setSize(panelVariable.getWidth(),panelVariable.getHeight());
        ClientesPanel.setLocation(0,0);
        panelVariable.removeAll();
        panelVariable.add(ClientesPanel, BorderLayout.CENTER);
    ...
    private void btnMembresiasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMembresiasActionPerformed
        ...
        MembresiasPanel MembresiasPanel = new MembresiasPanel(this);
        MembresiasPanel.setSize(panelVariable.getWidth(),panelVariable.getHeight());
        MembresiasPanel.setLocation(0,0);
        panelVariable.removeAll();
        panelVariable.add(MembresiasPanel, BorderLayout.CENTER);
        panelVariable.revalidate();
        panelVariable.repaint();
        btnInicio.setEnabled(true);
        btnVentas.setEnabled(true);
        btnUsuarios.setEnabled(true);
        btnMiembros.setEnabled(true);
        btnMembresias.setEnabled(false);
        btnMembresias.requestFocus();
        btnProductos.setEnabled(true);
        btnLlaves.setEnabled(true);
        
        PanelMembresias panelMembresias = new PanelMembresias();
        panelMembresias.setVisible(true);
        panelMembresias.setVisible(false);
    }//GEN-LAST:event_btnMembresiasActionPerformed

    private void btnProductosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProductosActionPerformed
        lblTitulo.setText("Productos");
        
        ProductosPanel ProductosPanel = new ProductosPanel(this);
        ProductosPanel.setSize(panelVariable.getWidth(),panelVariable.getHeight());
        ProductosPanel.setLocation(0,0);
        panelVariable.removeAll();
        panelVariable.add(ProductosPanel, BorderLayout.CENTER);
        panelVariable.revalidate();
        panelVariable.repaint();
