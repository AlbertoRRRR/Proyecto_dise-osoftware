 ...
 * @author alber
 */
public class panelConfirmacionJFrame extends javax.swing.JDialog {

    /**
     * Creates new form panelConfirmacion1
     */
    public panelConfirmacionJFrame(javax.swing.JFrame parent, boolean modal, String titulo, String mensaje, String tipo, int apoyo, String[] valores) {
        super(parent, modal);
        initComponents();
        initStyles();
        ...
        public void actionPerformed(ActionEvent e){
                if("eliminarMembresia".equals(tipo)){
                ...
                if("eliminarCliente".equals(tipo)){
                    ...
                    objetoclientes.EliminarClientes(apoyo);
                }
                if("eliminarProducto".equals(tipo)){
                    CProducto objetoProducto = new CProducto();
                    objetoProducto.EliminarProducto(apoyo);
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(panelConfirmacionJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                panelConfirmacionJFrame dialog = new panelConfirmacionJFrame(new javax.swing.JFrame(), true, "Título de la ventana", "Mensaje de confirmación","",1, new String[]{});
